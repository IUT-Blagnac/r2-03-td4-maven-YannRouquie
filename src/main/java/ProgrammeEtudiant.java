...
public class ProgrammeEtudiant
{
    public static void main (String[] args) {
        ...
        Adresse adre1 = new Adresse ();
        afficheAdresse(adre1);

        Adresse adre2 = new Adresse (13,"rue des Noyers","31500","Toulouse");
        afficheAdresse(adre2);
        ...
        for(int i = 0; i < nbEtudiants; i++) {
            System.out.println("Nom : "+tabInfo[i].nom + " prénom " +tabInfo[i].prenom+ " adresse " + tabInfo[i].adr.numRue);
        }
    ...
    /**
     * Role : Permet d'afficher l'adresse passer en parametre
     * 
     * @param pfadr : l'adresse a traiter 
     */
    public static void afficheAdresse (Adresse pfadr){

        System.out.println(pfadr.numRue +" "+  pfadr.nomRue +" "+ pfadr.codePostal + " "+ pfadr.ville);
